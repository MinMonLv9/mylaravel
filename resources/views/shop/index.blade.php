...
{{-- @section('banner image')
    <div class="banner border border-dark rounded-1" style="padding:0;">
        <img src="https://s3.amazonaws.com/lpl-files/655949104918551848/Images/655949104918551848-Icons-wholesalesuppliercentral.jpg"
...
@section('ContentB_DataArea')
    ...
    <div class="row mt-3 mb-3">
        {{-- search-start --}}
        <div class="col-6">
            <form action="{{ url('shopprocess/search') }}" method="GET" role="search">
    ...
    <table class="table">
        @forelse ($data as $shop)
            ...
            <tr>
                <td><img src="{{ asset('upload/' . $shop->image) }}" width="100" height="100px" alt="">
                </td>
                <td>{{ $shop->shopname }}</td>
                <td>{{ $shop->address }}</td>
                <td>{{ $shop->township }}</td>
                ...
                <td>
                    <div class="btn-group">
                        <a class="btn btn-primary border rounded-1"
                            href="{{ url('shopprocess/' . $shop->id . '/approve') }}">
                            Approve
                        </a>
                        <a class="btn btn-danger border rounded-1"
                            href="{{ url('shopprocess/' . $shop->id . '/decline') }}">
                            Decline
                        </a>
                    </div>
                </td>
