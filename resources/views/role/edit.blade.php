...
@section('ContentB_DataArea')
    ...
    <table class="table">
        ...
        <table class="table">
            ...
            <hr>
            <form action="{{ route('roleprocess.update', ['roleprocess' => $role->id]) }}" method="POST"
                ...
                <div class="flex-row w-100 justify-content-end">
                    <button type="submit" class="btn mt-3 w-25 mx-auto btn-primary">Update</button>
                    <a class="btn btn-danger mt-3" href="{{ url('roleprocess') }}">
                        Cancel
                    </a>
                </div>
            </form>
