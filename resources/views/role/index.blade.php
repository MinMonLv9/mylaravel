...
@section('ContentB_DataArea')
    ...
    <div class="row mt-3 mb-3">
        {{-- search-start --}}
        <div class="col-8">
            <form action="{{ url('roleprocess/search') }}" method="GET" role="search">
        ...
        <div class="col-4 d-inline-flex justify-content-end ">
            <a class="btn btn-primary" href="{{ url('roleprocess/create') }}">
                    ...
                    <td>
                        <div class="btn-group">
                            <a class="btn btn-warning border rounded-1"
                                href="{{ route('roleprocess.edit', ['roleprocess' => $role->id]) }}">
                                Edit
                            </a>
